        ...
        <div class="col-9 mt-4">
            <div class="card">
                <div class="card-body">
                    ...
                    @endif
                    <form class="custom-validation" action="{{ route('employee.update', $employee->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class=" row mb-3">
                        ...
                        <div class=" row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="phone" required parsley-type="phone"
                                    name="phone" placeholder="Enter a valid phone number" value="{{ $employee->phone }}" />
                            </div>
                        </div>
                        ...
                        <div class=" row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input data-parsley-type="number" type="date" class="form-control" required
                                    id="dob" name="dob" placeholder="Enter only numbers" value="{{ $employee->dob }}"/>
                            </div>
                        </div>
