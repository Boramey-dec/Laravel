                        ...
                        <tbody>
                            @foreach ($branches as $key => $branch)
                                <tr>
                                    ...
                                    {{-- <td>{{ $employee->id }}</td> --}}
                                    <td>{{ $branch->b_name }}</td>
                                    <td>{{ $branch->b_email }}</td>
                                    <td>{{ $branch->b_phone }}</td>
                                    <td>{{ $branch->location->province }}</td>
                                    <td>{{ $branch->created_at->toDateString() }}</td>
                                    @if ($branch->status == 'Open')
                                        <td>
                                        <a href="#" class="badge rounded-pill bg-success" style="font-size:1.1em">{{ $branch->status }}</a>
                                        </td>
                                    @else
                                        <td>
                                            <a href="#" class="badge rounded-pill bg-danger" style="font-size:1.1em">{{ $branch->status }}</a>
                                        </td>
                                    @endif
                                    <td>
